...
openssl req -new -key test/bdd/fixtures/keys/tls/ec-key.pem -subj "/C=CA/ST=ON/O=Example Inc.:sidetree-ipfs/OU=sidtree-ipfs/CN=localhost" -out test/bdd/fixtures/keys/tls/ec-key.csr
