...
echo "Generating sidetree-ipfs Test PKI"

# TODO re-use the sandbox CA script https://github.com/trustbloc/sidetree-ipfs/issues/131
cd /opt/workspace/sidetree-ipfs
...
openssl req -new -key test/bddtests/fixtures/keys/tls/ec-key.pem -subj "/C=CA/ST=ON/O=Example Inc.:sidetree-ipfs/OU=sidtree-ipfs/CN=localhost" -out test/bddtests/fixtures/keys/tls/ec-key.csr
...
echo "done generating sidetree-ipfs PKI"
