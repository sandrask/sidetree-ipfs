...
import (
	...
	"github.com/trustbloc/sidetree-ipfs/test/bdd/restclient"
)
...
// NewDIDSideSteps
func NewDIDSideSteps(context *BDDContext, namespace string) *DIDSideSteps {
	return &DIDSideSteps{bddContext: context, namespace: namespace}
}
